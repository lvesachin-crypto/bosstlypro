...
DO $$ BEGIN ALTER TABLE public."transactions" ADD CONSTRAINT "transactions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE set null ON UPDATE no action;; EXCEPTION WHEN duplicate_object OR duplicate_table THEN NULL; END $$;DO $$ BEGIN ALTER TABLE public."user_roles" ADD CONSTRAINT "user_roles_user_id_unique" UNIQUE("user_id"); EXCEPTION WHEN duplicate_object OR duplicate_table THEN NULL; END $$;
