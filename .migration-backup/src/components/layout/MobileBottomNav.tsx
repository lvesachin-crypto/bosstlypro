...
export function MobileBottomNav() {
  ...
  return (
    <>
      ...
      {sidebarOpen && (
        <>
          <div className="fixed inset-0 bg-black/30 z-50 md:hidden backdrop-blur-sm" onClick={() => setSidebarOpen(false)} />
          <div className="fixed inset-y-0 left-0 z-50 w-[280px] md:hidden shadow-xl">
